 ...
 * Validates request data for replacing all items in an option
 */
...
export const replaceItemsValidator = [
  ...
  body('defaultMaxQuantity')
    .optional()
    .isInt({ min: 1, max: 100 })
    .withMessage('Default max quantity must be an integer between 1 and 100'),

  body('defaultActive')
    .optional()
    .isBoolean()
    .withMessage('Default active must be a boolean'),
];
