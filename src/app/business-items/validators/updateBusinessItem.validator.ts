/**
 * Update Business Item Validator
 * Validates request data for updating a business item
 * Note: itemId and businessId are not allowed in updates
 */
...
export const updateBusinessItemValidator = [
  param('id')
    .notEmpty()
