// src/models/business-item.model.ts
/**
 * =============================================================================
 * BusinessItemModel – Sequelize (sequelize-typescript)
 * =============================================================================
...
@Table({
  ...
  timestamps: true,
  indexes: [
    { name: 'idx_business_items_business_id', fields: ['businessId'] },
    { name: 'idx_business_items_type', fields: ['type'] },
    { name: 'idx_business_items_category', fields: ['category'] },
    { name: 'idx_business_items_available', fields: ['available'] },
    { name: 'idx_business_items_featured', fields: ['featured'] },
    { name: 'idx_business_items_price', fields: ['price'] },
    { name: 'idx_business_items_halal', fields: ['isHalal'] },
    { name: 'idx_business_items_vegan', fields: ['isVegan'] },
    { name: 'idx_business_items_vegetarian', fields: ['isVegetarian'] },
    { name: 'idx_business_items_gluten_free', fields: ['isGlutenFree'] },
    {
      name: 'idx_business_items_business_name',
      fields: ['businessId', 'name'],
      unique: true,
    },
    { name: 'idx_business_items_sku', fields: ['sku'] },
    { name: 'idx_business_items_barcode', fields: ['barcode'] },
  ],
})
export class BusinessItemModel
  extends Model<BusinessItemAttributes, BusinessItemCreationAttributes>
  implements BusinessItemAttributes
{
  ...
  @Index('idx_business_items_business_id')
  @Column({
    type: DataType.UUID,
    allowNull: false,
  })
  ...
  @Index('idx_business_items_category')
  @Column({
  ...
  @Index('idx_business_items_price')
  @Column({
  ...
  @Index('idx_business_items_halal')
  @Column({
  ...
  @Index('idx_business_items_vegan')
  @Column({
    type: DataType.BOOLEAN,
    allowNull: false,
    defaultValue: false,
  ...
  @Index('idx_business_items_vegetarian')
  @Column({
    type: DataType.BOOLEAN,
    allowNull: false,
    defaultValue: false,
  ...
  @Index('idx_business_items_gluten_free')
  @Column({
    type: DataType.BOOLEAN,
    allowNull: false,
    defaultValue: false,
  ...
  @Index('idx_business_items_available')
  @Column({
    type: DataType.BOOLEAN,
    allowNull: false,
    defaultValue: true,
  ...
  @Index('idx_business_items_featured')
  @Column({
    type: DataType.BOOLEAN,
    allowNull: false,
    defaultValue: false,
  ...
  @Index('idx_business_items_barcode')
  @Column({
    type: DataType.STRING(50),
    allowNull: true,
  })
  ...
  @BeforeCreate
  @BeforeUpdate
  static normalizeFields(instance: BusinessItemModel) {
    // Normalize name
  ...
  @BeforeCreate
  @BeforeUpdate
  static validatePricing(instance: BusinessItemModel) {
  ...
  @BeforeCreate
  @BeforeUpdate
  static validateOrderQuantities(instance: BusinessItemModel) {
  ...
  @BeforeCreate
  @BeforeUpdate
  static validateDietaryConsistency(instance: BusinessItemModel) {
