...
import { BusinessItemModel, SpicyLevel } from '../models/business-item.model.js';
 ...
 * @example
 * ```typescript
 * const results = await searchBusinessItems({
 *   query: 'pizza',
 *   isVegetarian: true,
 *   maxPrice: 15,
 *   available: true
 ...
 * ```
 */
export const searchBusinessItems = async (
  criteria: BusinessItemSearchCriteria
