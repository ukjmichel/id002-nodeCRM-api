...
import { countBusinessItems } from '../services/countBusinessItems.js';
 ...
 */
export const countBusinessItemsController = async (
  req: Request,
  res: Response,
  next: NextFunction
): Promise<void> => {
  try {
    ...
    const result = await countBusinessItems(whereClause);
